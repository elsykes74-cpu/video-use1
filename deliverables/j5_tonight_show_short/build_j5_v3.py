#!/usr/bin/env python3
"""J5 viral Short V3: George voice, 4K 2160x3840, watermark removed,
   modern word-group captions synced to George timestamps."""
...
ASS_OUT   = f"{SCRATCHPAD}/j5_captions_v3.ass"
VIDEO_OUT = f"{SCRATCHPAD}/j5_SHORT_4K_v3.mp4"
...
WM = "drawbox=x=0:y=3490:w=1500:h=350:color=black@0.85:t=fill"
...
print("4K encode starting (George voice)…")
sys.stdout.flush()
